    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
             Padding(
              padding: EdgeInsets.only(top: MediaQuery.of(context).size.width/6, bottom: 5.0, left: MediaQuery.of(context).size.width / 9),
              child: const Text("Good afternoon"),
            ), //TODO: backend login here
            Padding(
              padding:  EdgeInsets.only(top: MediaQuery.of(context).size.width / 35, left: MediaQuery.of(context).size.width / 9),
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: (() => {Navigator.of(context).pushNamed("/dashboard/registration")}),
                  child: Container(
                    height: 100,
                    width: 120,
