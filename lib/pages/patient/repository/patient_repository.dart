...
class PatientRepositories {
  ...
  Future<http.Response?> fetchPatient(
      {required String patientId, required String token}) async {
    var uri = Uri.parse(root + "api/rest/v1/patient/$patientId");
  ...
  Future<http.Response?> editPatientData(
